export default {
  ...
  createEvent: {
    ...
    popup: {
      ...
      readLink: 'Voir l\'événement',
      writeLink: 'Modifier l\'événement',
      viewBtn: 'Voir l\'événement',
      editBtn: 'Modifier l\'événement',
      linksTitle: 'Liens de l\'événement',
      linksDisclaimer: 'Si vous n\'avez pas renseigné d\'e-mail, c\'est la dernière fois que vous pourrez voir ces liens. Copiez-les maintenant !',
    ...
    confirm: {
      title: 'Confirmer la création de l\'événement',
      cancel: 'Annuler',
      validate: 'Valider',
    },
    contact: {
